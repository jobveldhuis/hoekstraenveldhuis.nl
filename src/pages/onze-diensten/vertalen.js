...
export default function CopyWriting () {
  return (
        <LandingPage
            heading='Vertalingen van Engels en Nederlands'
            pageName='Vertalingen Engels / Nederlands'
            description='Laat uw Engelstalige of Nederlandstalige teksten vertalen door onze gecertificeerde taalliefhebbers met oog voor uw tekst.'
        ...
        >
            ...
            <h2>Professionele vertaling: veel beter dan Google Translate</h2>
            <p>
