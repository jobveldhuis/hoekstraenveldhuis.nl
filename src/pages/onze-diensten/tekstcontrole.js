...
export default function TextCheck () {
  return (
        <LandingPage
            heading='Tekstcontrole en -advies'
            pageName='Tekstcontrole door experts'
            description='Laat uw teksten door een expert controleren en voorkom ergernis door taalfouten of het gebrek aan een duidelijke boodschap.'
        ...
        >
            ...
            <h2>Meer dan spelling en grammatica</h2>
            <p>
            ...
            <h2>Waarom Hoekstra & Veldhuis?</h2>
            <p>
