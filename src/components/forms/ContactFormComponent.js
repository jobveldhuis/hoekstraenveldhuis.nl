...
//                 <div className={`form-group ${styles.group}`}>
//                     <label>Uw naam</label>
//                     <input type="text" className={this.state.errors.user_name ? `form-control ${styles.error}` : 'form-control'} name="name" value={this.state.input.name} onChange={this._handleChange}/>
//                     <small className={'form-text text-muted'}>{this.state.errors.user_name}</small>
//                 </div>
//                 <div className={`form-group ${styles.group}`}>
//                     <label>Uw emailadres</label>
//                     <input type="email" className={this.state.errors.user_email ? `form-control ${styles.error}` : 'form-control'} name="email" value={this.state.input.email} onChange={this._handleChange}/>
